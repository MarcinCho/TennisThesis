...
def basicStats(db, name, match):
    ...
    if namep1.empty:
        ...
        # df_probability = namep2['df_P2'].mean(
        # ) / namep2['svpt_P1'].mean() if namep2['svpt_P1'].mean() != 0 else 0.1

        first_serve_return = namep2['1stIn_P1'].mean(
        ) - namep2['1stWon_P1'].mean()
        ...
        # df_probability = namep1['df_P1'].mean(
        # ) / namep1['svpt_P1'].mean() if namep1['svpt_P1'].mean() != 0 else 0.1

        first_serve_return = namep1['1stIn_P2'].mean(
        ) - namep1['1stWon_P2'].mean()
        ...
        # df_probability = (namep1['df_P1'].mean() + namep2['df_P2'].mean()) / (namep1['svpt_P1'].mean(
        # ) + namep2['svpt_P2'].mean()) if (namep1['svpt_P1'].mean() + namep2['svpt_P2'].mean()) != 0 else 0.1
        # gu and satay
        first_serve_return = namep1['1stIn_P2'].mean(
        ) - namep1['1stWon_P2'].mean() + namep2['1stIn_P1'].mean() - namep2['1stWon_P1'].mean()
